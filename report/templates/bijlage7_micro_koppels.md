...
![](../../output/figures/figB7-1_equivalentiegraad_koppels.png)
...
|----------------------------|--------------:|-----------:|--------------:|-----------:|
| Werknemer | {{mi_eq_k_z_wn_m2_gem}} | {{mi_eq_k_z_wn_m2_vc}} | {{mi_eq_k_w_wn_m13_gem}} | {{mi_eq_k_w_wn_m13_vc}} |
| Zelfstandige, eenmanszaak | {{mi_eq_k_z_ze_x_gem}} | {{mi_eq_k_z_ze_x_vc}} | {{mi_eq_k_w_ze_x_gem}} | {{mi_eq_k_w_ze_x_vc}} |
| Vennootschap, 100% loon (met VAA) | {{mi_eq_k_z_zv100vaa_x_gem}} | {{mi_eq_k_z_zv100vaa_x_vc}} | {{mi_eq_k_w_zv100vaa_x_gem}} | {{mi_eq_k_w_zv100vaa_x_vc}} |
| Vennootschap, 75% loon | {{mi_eq_k_z_zv75_x_gem}} | {{mi_eq_k_z_zv75_x_vc}} | {{mi_eq_k_w_zv75_x_gem}} | {{mi_eq_k_w_zv75_x_vc}} |
| Vennootschap, 50% loon | {{mi_eq_k_z_zv50_x_gem}} | {{mi_eq_k_z_zv50_x_vc}} | {{mi_eq_k_w_zv50_x_gem}} | {{mi_eq_k_w_zv50_x_vc}} |
| Vennootschap, 0% loon | {{mi_eq_k_z_zv00_x_gem}} | {{mi_eq_k_z_zv00_x_vc}} | {{mi_eq_k_w_zv00_x_gem}} | {{mi_eq_k_w_zv00_x_vc}} |
...
![](../../output/figures/figB7-2_vervangingsgraad_koppels.png)
...
| | **Arbeidsongeschiktheid: X̅** | **VC** | **Werkloosheid/overbrugging: X̅** | **VC** |
|----------------------------|--------------:|-----------:|--------------:|-----------:|
| Werknemer | {{mi_vv_k_z_wn_m2_gem}} | {{mi_vv_k_z_wn_m2_vc}} | {{mi_vv_k_w_wn_m13_gem}} | {{mi_vv_k_w_wn_m13_vc}} |
| Zelfstandige (alle rechtsvormen) | {{mi_vv_k_z_zs_x_gem}} | {{mi_vv_k_z_zs_x_vc}} | {{mi_vv_k_w_zs_x_gem}} | {{mi_vv_k_w_zs_x_vc}} |
